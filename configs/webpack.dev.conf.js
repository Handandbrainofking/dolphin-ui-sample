...
// const openPage = 'web/test.html?page=index.js&entrys=components/HelloWorld|index';
console.log('common entry:', commonConfig[0].entry)
console.log('openPage url:', openPage)
